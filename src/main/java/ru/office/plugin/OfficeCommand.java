...
public class OfficeCommand implements CommandExecutor, TabCompleter {
    ...
    private void sendHelp(Player player) {
        ...
        player.sendMessage(C.YELLOW + "  /office <ник>" + C.GRAY + " — отправить запрос на трейд");
        ...
        player.sendMessage(C.GRAY   + "  Стоимость трейда: " + C.GOLD
                + OfficePlugin.getEconomy().format(TradeRequest.TRADE_COST));
        player.sendMessage(C.BAR);
        player.sendMessage("");
    }
